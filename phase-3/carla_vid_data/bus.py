...
def main():
    ...
    try:
        ...
        # --- SPAWN SEMI TRUCK ---
# The Volkswagen T2 is the classic minibus included in CARLA 0.9.10
        ...
        spawn_point.location.z += 2.0  # Drop it slightly from the air so it doesn't get stuck
        ...
        print(f"\n--- VEHICLE SPECS ---")
        print(f"Vehicle: CarlaCola Truck")
        ...
        while running:
            ...
            # Pulled the spectator back to 15 meters and up 7 meters so the long trailer is visible
            spectator_offset = -15.0 * car_transform.rotation.get_forward_vector() + carla.Location(z=7.0)
