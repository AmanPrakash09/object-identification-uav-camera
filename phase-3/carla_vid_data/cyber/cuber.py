...
def get_bbox_and_draw(image, actor, camera, K):
    ...
    if len(points_2d) > 0:
        ...
        if width > 0 and height > 0:
            ...
            cv2.putText(image, 'Pickup Truck', (x_min, max(15, y_min - 10)), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 2)
...
def main():
    ...
    coco_data = {
        "images": [],
        "annotations": [],
        "categories": [{"id": 1, "name": "pickup_truck", "supercategory": "vehicle"}]
    }
    annotation_id = 1
    ...
    try:
        ...
        while running:
            ...
            # --- PYGAME KEYBOARD CONTROL FOR VEHICLE ---
            ...
            spectator_offset = -8.0 * vehicle_transform.rotation.get_forward_vector() + carla.Location(z=4.0)
