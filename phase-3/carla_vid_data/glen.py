...
def main():
    ...
    # --- OR USE CUSTOM WEATHER (Uncomment the block below to use) ---
    custom_weather = carla.WeatherParameters(
         cloudiness=40.0,           # 0.0 to 100.0
         precipitation=40.0,        # Rain intensity (0.0 to 100.0)
         precipitation_deposits=10.0, # Puddles on the road (0.0 to 100.0)
         fog_density=0.0,          # 0.0 to 100.0
         sun_altitude_angle=90.0    # 90.0 is noon, 0.0 is sunset, -90.0 is midnight
    )
