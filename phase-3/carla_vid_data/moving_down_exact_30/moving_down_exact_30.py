...
def main():
    ...
    try:
        ...
        print("The drone will spawn 20m to the right and drift NORTH (Forward) along the X-axis.")
        ...
        while True:
            ...
            # Changed to += .x so it moves FORWARD / NORTH along the map surface
            current_cam_transform.location.x -= (CAMERA_SPEED_MPS * DELTA_TIME)
