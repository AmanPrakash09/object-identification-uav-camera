...
def main():
    ...
    try:
        ...
        # Spawn Recording Camera (Stationary, but offset 20m)
        ...
        camera_transform = carla.Transform(
            carla.Location(
                ...
                y=spawn_point.location.y + 20.0,  # <-- 20 meters offset to the right
        ...
        print("Camera is completely stationary, offset by 20m to the right.")
