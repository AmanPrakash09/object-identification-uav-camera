...
def main():
    ...
    try:
        ...
        camera_transform = carla.Transform(
            carla.Location(x=spawn_point.location.x, y=spawn_point.location.y+18.0, z=spawn_point.location.z + 25.0),
        ...
        while True:
            ...
            # Grab the direction the car is facing and force its velocity to match our target exactly
            ...
            # Print to terminal instead of a Pygame window
