...
try:
    while True:
        ...
        with open(label_filepath, "w") as f:
            if detections:
                for d in detections:
                    ...
                    # Draw the green box and the English name
        ...
        print(f"Saved frame {img_id:05d} | Found {len(detections) if detections else 0} objects.")
        
        img_id += 1
        time.sleep(1) # Takes a picture every 1 second
