...
if __name__ == '__main__':
    ...
    segIdDict = {'Base_Terrain':'soil',
                 'ANIM_Crocodile':'crocodile',
                 'ANIM_Rhinoceros':'rhinoceros',
                 'ANIM_Hippopotamus':'hippopotamus',
                 'African_Poacher':'human',
    ...
    # Choose temperature values for winter
    tempEmissivity = numpy.array([['rhinoceros',291,0.96],
                                  ...
                                  ['shrub',273,0.986],
                                  ['water',273,0.96],
                                  # --- MAKE THE CAR HOT (like a running engine) ---
                                  ['car',305,0.90]])
